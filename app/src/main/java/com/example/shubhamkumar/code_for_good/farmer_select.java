...
public class farmer_select extends AppCompatActivity {
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                               try {
                                   ...
                                   sm.sendTextMessage("919590984828", null, "Confirmation message:", null, null);
                                Intent intent1=new Intent(farmer_select.this, com.example.shubhamkumar.code_for_good.ConfirmationPage.class);
    ...
    public void makeServerCall(String start, String end) {
        ...
        JsonArrayRequest req = new JsonArrayRequest(com.example.shubhamkumar.code_for_good.Constants.EQUIPMENT_DETAILS+"?start_date="+start+"&end_date="+end,
